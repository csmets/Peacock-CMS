...
<head>
    <title>Peacock>Dashboard | Delete Page</title>
    ...
    <div id="pContentWrapper">
        ...
        <div class="pContentBox">
            ...
            <div class="pContentBoxContent">
                <?php
                    echo "<p class='pbodyTxt'>Are you sure you want to delete <b>" . $pagename . "?</b></p>";
                    echo "<a href='deletePageSubmission.php?id=$pageid' class='pLinkTxt'>Click here to delete</a>";
                ?>
            </div>
        </div>
