...
(6, 'Gallery', '<h1>Gallery</h1> <p>Below are selected works.</p>', 'Gallery.php', 'default-EditPage.php?id=6', 'SimpleGallery', 'relink', 'no', '', 'active', 2, 0, '', 'false', 0);
